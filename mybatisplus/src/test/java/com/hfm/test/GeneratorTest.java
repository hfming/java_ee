...
public class GeneratorTest {
    ...
    public void generatorTest() {
        ...
        globalConfig.setActiveRecord(true)  //是否支持AR模式
                .setAuthor("hfm")  //设置作者
                .setOutputDir("D:\\Code\\java_ee\\mybatisplus\\src\\main\\java")  //设置生成路径
        ...
        dataSourceConfig.setDriverName("com.mysql.jdbc.Driver")
                .setUrl("jdbc:mysql://47.99.213.57:3306/jpa?characterEncoding=utf8&amp;useSSL=false")
                .setUsername("root")
...
//                .setDbColumnUnderline(true) // 使用下划线 3.0 默认开启不需要配置
                ...
                .setTablePrefix("mb_")//设置表名前缀
                .setInclude("mb_user");//生成需要的表
